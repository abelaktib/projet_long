...
X_train = tfio.IODataset.from_hdf5(
    'data/small_database_window13.h5', dataset="/x_train")
# print (X_train)
Y_train = tfio.IODataset.from_hdf5(
    'data/small_database_window13.h5', dataset="/y_train")
# print (Y_train)
sample_weights = tfio.IODataset.from_hdf5(
    'data/small_database_window13.h5', dataset="/sample_weight")
# print (sample_weights)

X_test = tfio.IODataset.from_hdf5(
    'data/small_database_window13.h5', dataset="/x_test")
# print (X_test)
Y_test = tfio.IODataset.from_hdf5(
    'data/small_database_window13.h5', dataset="/y_test")
# print (Y_test)
